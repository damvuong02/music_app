...
class AudioPlayerHandlerImpl extends BaseAudioHandler
  ...
  Future<void> addQueueItem(MediaItem mediaItem) async {
    ...
    _mediaLibrary.addItem(mediaItem);
  }
  ...
  Future<void> removeQueueItem(MediaItem mediaItem) async {
    ...
    _mediaLibrary.removeItem(index);
  }
...
class MediaLibrary {
  ...
  // Tạo một biến static để giữ instance duy nhất của lớp
  static final MediaLibrary _instance = MediaLibrary._internal();
  ...
  // Hàm tạo private để đảm bảo chỉ có thể tạo instance từ bên trong lớp
  MediaLibrary._internal();
  ...
  void addItems(List<MediaItem> list) {
    items[albumsRootId]!.clear();
    items[albumsRootId]!.addAll(list);
  }

  void addItem(MediaItem item) {
    items[albumsRootId]!.add(item);
  }

  void removeItem(index) {
    items[albumsRootId]!.removeAt(index);
  }
}

// MediaItem(
//   id: '/storage/emulated/0/CSNMusic/Download/Music/2112976__Blue Tequila__Táo__128.mp3',
...
// ),
// MediaItem(
//   id: '/storage/emulated/0/CSNMusic/Download/Music/3107__Duongg;   Nâu__128.mp3',
//   album: "Science Friday",
...
// ),
// MediaItem(
//   id: '/storage/emulated/0/CSNMusic/Download/Music/1726256__Đường Một Chiều__Huỳnh Tú__128.mp3',
//   album: "Science Friday",
